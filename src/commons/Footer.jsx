...
const Footer = () => {
  ...
  <div class="content has-text-centered ">
    ...
    <a href="https://www.linkedin.com/in/emiliano-sasal/" target="_blank" rel="noreferrer"><FaLinkedin className="icon-custom"/></a>   <a href="https://github.com/emisasal" target="_blank" rel="noreferrer"><FaGithubSquare className="icon-custom"/></a>
    </h4>
  </div>
</footer>
    )
